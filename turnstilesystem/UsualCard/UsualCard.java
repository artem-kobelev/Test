 ...
 */
package turnstilesystem.UsualCard;
 ...
 */
public class UsualCard implements ICard{
    ...
    public UsualCard(ICheck ch, int id, Date beginDate, 
            int countOfDays, int countOfTrips, double balance) throws CannotCreateClassException{
        if (ch == null){
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        final UsualCard other = (UsualCard) obj;
        if (this.id != other.id) {
            return false;
        }
        return true;
